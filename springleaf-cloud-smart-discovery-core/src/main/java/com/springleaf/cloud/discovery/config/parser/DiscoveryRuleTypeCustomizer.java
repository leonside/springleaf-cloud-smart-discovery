...
/**
 * Config DataSource custom extension class of the diccovery configuration rule type.
 *
 ...
 * @author leon
 */
public class DiscoveryRuleTypeCustomizer implements RuleTypeCustomizer {

    private RuleCacher ruleCacher;

    public DiscoveryRuleTypeCustomizer(RuleCacher ruleCacher){
    ...
    public String supportRuleType() {
        return RuleType.DISCOVERY.name();
    }
}
